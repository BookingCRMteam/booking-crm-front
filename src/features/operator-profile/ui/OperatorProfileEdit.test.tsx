...
import { mockOperator } from './OperatorProfile.test';
import { OperatorProfileEdit } from './OperatorProfileEdit';

const renderWithTheme = (ui: ReactNode) =>
  render(<ThemeProvider theme={theme}>{ui}</ThemeProvider>);

jest.mock('./ImagesInput', () => ({
  __esModule: true,
...
describe('CoupleProfileForm', () => {
  ...
  it('renders all form fields', () => {
    ...
    expect(screen.getByPlaceholderText('Філософія')).toBeInTheDocument();
